...
<head>
    <meta charset="utf-8">
    <title>Résultats d'import des mappings</title>
    <style>
        body {
        ...
        .header {
            background: linear-gradient(135deg, #7e5bef, #6d28d9);
            color: white;
            padding: 20px;
        ...
        .summary-box.total { border-color: #7e5bef; }
        ...
        .summary-box.total .value { color: #7e5bef; }
...
<body>
    <div class="header">
        <h1>Résultats d'import des mappings</h1>
        <p>Correspondances comptables</p>
    </div>
