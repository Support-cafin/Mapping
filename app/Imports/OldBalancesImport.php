...
class OldBalancesImport implements ToModel, WithHeadingRow, WithValidation, WithBatchInserts, WithChunkReading, SkipsOnError, SkipsOnFailure
{
    ...
    public function model(array $row)
    {
        ...
        $account = OldAccount::where('entreprise_id', $this->entrepriseId)
